...
function LanguageProvider(param) {
                                ...
                                "LanguageProvider.useEffect.loadTranslations": function(_state) {
                                    switch(_state.label){
                                        ...
                                        case 2:
                                            ...
                                            console.log("Loaded translations for ".concat(lang, ":"), Object.keys(data).length, 'keys');
                                            return [
                                                3,
                                                4
                                            ];
    ...
    var t = function(key) {
        ...
        var getNestedTranslation = function(obj, path) {
            var keys = path.split('.');
            var result = obj;
            ...
            try {
                for(var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                    var k = _step.value;
                    if (result && (typeof result === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$mazhar_rony$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(result)) === 'object' && k in result) {
                        result = result[k];
                    } else {
...
_s(LanguageProvider, "eIn8748443Fx1kh7q9+d+NPrfDU=");
_c = LanguageProvider;
...
"[project]/mazhar_rony/lib/i18n/LanguageConfirmation.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var LanguageConfirmation = function() {
    _s();
    var _useLanguage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mazhar_rony$2f$lib$2f$i18n$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])(), showConfirmation = _useLanguage.showConfirmation, detectedLanguage = _useLanguage.detectedLanguage, confirmLanguage = _useLanguage.confirmLanguage, dismissConfirmation = _useLanguage.dismissConfirmation;
    var languageNames = {
        ar: 'العربية (Arabic)',
        ru: 'Русский (Russian)',
        zh: '中文 (Chinese)',
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mazhar_rony$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            ...
                            ".",
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$mazhar_rony$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, void 0, false, {
                                fileName: "[project]/mazhar_rony/lib/i18n/LanguageConfirmation.tsx",
                                lineNumber: 46,
                                columnNumber: 15
                            }, _this),
...
//# sourceMappingURL=mazhar_rony_f8ffc2ce._.js.map